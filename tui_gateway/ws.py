...
class WSTransport:
    ...
    def __init__(
        ...
        *,
        ...
        # Profile authority is also established by the WS authentication
        # boundary.  Public ticket holders are pinned to the profile that this
        # backend process serves; only process-local/internal transports may
        # opt into cross-profile routing.
        self.authorized_profile = authorized_profile
        self.allow_profile_override = bool(allow_profile_override)
        self._closed = False
    ...
    *,
    ...
    try:
        ...
        transport = WSTransport(
            ...
            allow_profile_override=allow_profile_override,
        )
